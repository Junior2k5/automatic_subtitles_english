...
def translate_text(text, model, tokenizer, src_lang="ar", tgt_lang="en"):
    # Preprocess the text
...
def translate_subtitle_file(file_path, dest_folder, model, tokenizer, src_lang="ar", tgt_lang="en"):
...
def translate_all_subtitles_in_folder(folder_path, dest_folder, model, tokenizer, src_lang="ar", tgt_lang="en"):
...
if __name__ == "__main__":
    ...
    local_model_path = './local_model/opus-mt-ar-en' #download it from https://huggingface.co/Helsinki-NLP/opus-mt-ru-en
    ...
    translate_all_subtitles_in_folder(folder_path, dest_folder, model, tokenizer, src_lang="ar", tgt_lang="en")
